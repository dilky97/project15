...
import { sponsorData } from "../../../models/event-details.model";
...
export class SponsorsComponent implements OnInit{
  ...
  constructor(private modalService: NgbModal,private sponsorService:EventPlannerService, private sponsorStore:AngularFirestore) {
